...
struct Sheet627a: Running {
    ...
    init(oat: Double, elevation: Double, apu: Double, bleed: Double) {
        ...
        self.apu = apu
        self.bleed = bleed
        self.partOne = PolyNomogramPart(fileName: "627a-1_v625")
        self.partTwo = ShiftedLinePart(fileName: "apu_on_627a_v625")
        self.partThree = PolyNomogramPart(fileName: "627a-3_v625")
    }
